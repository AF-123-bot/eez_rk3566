...
static void event_handler_cb_main_page_btn_start_all(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_communicate_setting_page_btn_home(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_communicate_setting_page_b1(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_communicate_setting_page_b2(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_communicate_setting_page_b4(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_communicate_setting_page_b5(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_communicate_setting_page_btn_factory_reset(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_motor_test_setting_page_obj14(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_motor_test_setting_page_obj15(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_motor_test_setting_page_obj16(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_motor_test_setting_page_btn_rotate_motor_absolute_motion(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_motor_test_setting_page_btn_rotate_motor_incremental_motion(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_motor_test_setting_page_btn_rotate_motor_return_program0(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_motor_test_setting_page_btn_rotate_motor_return_mechanical0(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_motor_test_setting_page_input_rotational_speed(lv_event_t *e) {
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            const char *value = lv_textarea_get_text(ta);
            assignStringProperty(flowState, 40, 3, value, "Failed to assign Text in Textarea widget");
        }
    }
...
static void event_handler_cb_motor_test_setting_page_input_rotational_radius(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            const char *value = lv_textarea_get_text(ta);
            assignStringProperty(flowState, 45, 3, value, "Failed to assign Text in Textarea widget");
        }
    }
...
static void event_handler_cb_historical_record_page_obj20(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_historical_record_page_obj21(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_historical_record_page_obj22(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
void create_screen_main_page() {
    ...
    lv_obj_add_event_cb(obj, event_handler_cb_main_page_main_page, LV_EVENT_ALL, flowState);
    {
        ...
        }
        {
            // btn_start_all
            lv_obj_t *obj = lv_button_create(parent_obj);
            objects.btn_start_all = obj;
            lv_obj_set_pos(obj, 827, 663);
            lv_obj_set_size(obj, 156, 72);
            lv_obj_add_event_cb(obj, event_handler_cb_main_page_btn_start_all, LV_EVENT_ALL, flowState);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &ui_font_24, LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff0ddfcd), LV_PART_MAIN | LV_STATE_PRESSED);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff1976d2), LV_PART_MAIN | LV_STATE_CHECKED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
...
void create_screen_sample_setting_page() {
    ...
    lv_obj_add_event_cb(obj, event_handler_cb_sample_setting_page_sample_setting_page, LV_EVENT_ALL, flowState);
    {
        ...
        }
        {
            // ccw_counting_time
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.ccw_counting_time = obj;
            lv_obj_set_pos(obj, 227, 489);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_24, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text(obj, "ccw_counting_time");
        }
        {
            // cw_counting_time
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.cw_counting_time = obj;
            lv_obj_set_pos(obj, 476, 487);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_24, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text(obj, "cw_counting_time");
        }
        {
            // tips_sample
            lv_obj_t *obj = lv_label_create(parent_obj);
...
void create_screen_communicate_setting_page() {
    ...
    lv_obj_add_event_cb(obj, event_handler_cb_communicate_setting_page_communicate_setting_page, LV_EVENT_ALL, flowState);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_image_set_src(obj, &img_home);
            lv_obj_add_event_cb(obj, event_handler_cb_communicate_setting_page_btn_home, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_CLICKABLE);
        }
        {
            // title_3
        ...
        }
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff0ddfcd), LV_PART_MAIN | LV_STATE_PRESSED);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_pos(obj, 15, 305);
                    lv_obj_set_size(obj, 71, 72);
                    lv_obj_add_event_cb(obj, event_handler_cb_communicate_setting_page_b1, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff3195e4), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc9e7ff), LV_PART_MAIN | LV_STATE_PRESSED);
                    {
                        lv_obj_t *parent_obj = obj;
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 15, 120);
                    lv_obj_set_size(obj, 71, 72);
                    lv_obj_add_event_cb(obj, event_handler_cb_communicate_setting_page_b2, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc9e7ff), LV_PART_MAIN | LV_STATE_PRESSED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 15, 25);
                    lv_obj_set_size(obj, 71, 72);
                    lv_obj_add_event_cb(obj, event_handler_cb_communicate_setting_page_b4, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc9e7ff), LV_PART_MAIN | LV_STATE_PRESSED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 15, 395);
                    lv_obj_set_size(obj, 71, 72);
                    lv_obj_add_event_cb(obj, event_handler_cb_communicate_setting_page_b5, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc9e7ff), LV_PART_MAIN | LV_STATE_PRESSED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
        ...
        {
            // container_sr_restore
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.container_sr_restore = obj;
            lv_obj_set_pos(obj, 198, 97);
            lv_obj_set_size(obj, 680, 380);
            lv_obj_set_style_pad_left(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_top(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_right(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_bottom(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            ...
            lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_image_set_src(obj, &img_sr_restore);
                }
                {
                    lv_obj_t *obj = lv_button_create(parent_obj);
                    objects.obj12 = obj;
                    lv_obj_set_pos(obj, 450, 235);
                    lv_obj_set_size(obj, 134, 75);
                    lv_obj_add_event_cb(obj, event_handler_cb_communicate_setting_page_obj12, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff010101), LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_pos(obj, 739, 686);
            lv_obj_set_size(obj, 140, 50);
            lv_obj_add_event_cb(obj, event_handler_cb_communicate_setting_page_btn_factory_reset, LV_EVENT_ALL, flowState);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &ui_font_24, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff009ea2), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
...
void create_screen_motor_test_setting_page() {
    ...
    lv_obj_add_event_cb(obj, event_handler_cb_motor_test_setting_page_motor_test_setting_page, LV_EVENT_ALL, flowState);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_image_set_src(obj, &img_background2);
            lv_obj_add_event_cb(obj, event_handler_cb_motor_test_setting_page_obj14, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_CLICKABLE);
            lv_obj_add_state(obj, LV_STATE_PRESSED);
        }
        {
            ...
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_image_set_src(obj, &img_home);
            lv_obj_add_event_cb(obj, event_handler_cb_motor_test_setting_page_obj15, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_CLICKABLE);
        }
        {
            // title_1
        ...
        }
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff0ddfcd), LV_PART_MAIN | LV_STATE_PRESSED);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 15, 120);
                    lv_obj_set_size(obj, 71, 72);
                    lv_obj_add_event_cb(obj, event_handler_cb_motor_test_setting_page_obj16, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc9e7ff), LV_PART_MAIN | LV_STATE_PRESSED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
        ...
        }
        {
            ...
            lv_obj_set_style_radius(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
                    lv_obj_set_pos(obj, 388, 241);
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    add_style_font2(obj);
                    lv_obj_set_style_text_font(obj, &ui_font_24, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_label_set_text(obj, "旋转角度：");
                }
                {
                    // btn_sample_motor_cw
                    lv_obj_t *obj = lv_button_create(parent_obj);
                ...
                {
                    // btn_rotate_motor_absolute_motion
                    lv_obj_t *obj = lv_button_create(parent_obj);
                    objects.btn_rotate_motor_absolute_motion = obj;
                    lv_obj_set_pos(obj, 43, 309);
                    lv_obj_set_size(obj, 130, 50);
                    lv_obj_add_event_cb(obj, event_handler_cb_motor_test_setting_page_btn_rotate_motor_absolute_motion, LV_EVENT_ALL, flowState);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            ...
                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_font(obj, &ui_font_24, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text(obj, "绝对运动");
                        }
                    }
                }
                {
                    // btn_rotate_motor_incremental_motion
                    lv_obj_t *obj = lv_button_create(parent_obj);
                    objects.btn_rotate_motor_incremental_motion = obj;
                    lv_obj_set_pos(obj, 221, 309);
                    lv_obj_set_size(obj, 130, 50);
                    lv_obj_add_event_cb(obj, event_handler_cb_motor_test_setting_page_btn_rotate_motor_incremental_motion, LV_EVENT_ALL, flowState);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            ...
                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_font(obj, &ui_font_24, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text(obj, "增量运动");
                        }
                    }
                }
                {
                    // btn_rotate_motor_return_program0
                    lv_obj_t *obj = lv_button_create(parent_obj);
                    objects.btn_rotate_motor_return_program0 = obj;
                    lv_obj_set_pos(obj, 393, 309);
                    lv_obj_set_size(obj, 130, 50);
                    lv_obj_add_event_cb(obj, event_handler_cb_motor_test_setting_page_btn_rotate_motor_return_program0, LV_EVENT_ALL, flowState);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            ...
                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_font(obj, &ui_font_24, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text(obj, "回程序零");
                        }
                    }
                }
                {
                    // btn_rotate_motor_return_mechanical0
                    lv_obj_t *obj = lv_button_create(parent_obj);
                    objects.btn_rotate_motor_return_mechanical0 = obj;
                    lv_obj_set_pos(obj, 562, 309);
                    lv_obj_set_size(obj, 130, 50);
                    lv_obj_add_event_cb(obj, event_handler_cb_motor_test_setting_page_btn_rotate_motor_return_mechanical0, LV_EVENT_ALL, flowState);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        {
            // input_Rotational_radius
            lv_obj_t *obj = lv_textarea_create(parent_obj);
            objects.input_rotational_radius = obj;
            lv_obj_set_pos(obj, 680, 327);
            lv_obj_set_size(obj, 150, 57);
            lv_textarea_set_max_length(obj, 128);
            lv_textarea_set_one_line(obj, false);
            lv_textarea_set_password_mode(obj, false);
            lv_obj_add_event_cb(obj, event_handler_cb_motor_test_setting_page_input_rotational_radius, LV_EVENT_ALL, flowState);
            lv_obj_add_state(obj, LV_STATE_PRESSED);
        }
    }
...
void tick_screen_motor_test_setting_page() {
    ...
    (void)flowState;
    {
        const char *new_val = evalTextProperty(flowState, 40, 3, "Failed to evaluate Text in Textarea widget");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 45, 3, "Failed to evaluate Text in Textarea widget");
        const char *cur_val = lv_textarea_get_text(objects.input_rotational_radius);
        uint32_t max_length = lv_textarea_get_max_length(objects.input_rotational_radius);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.input_rotational_radius;
            lv_textarea_set_text(objects.input_rotational_radius, new_val);
            tick_value_change_obj = NULL;
        }
    }
}
...
void create_screen_historical_record_page() {
    ...
    lv_obj_add_event_cb(obj, event_handler_cb_historical_record_page_historical_record_page, LV_EVENT_ALL, flowState);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_image_set_src(obj, &img_home);
            lv_obj_add_event_cb(obj, event_handler_cb_historical_record_page_obj20, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_CLICKABLE);
        }
        {
            // title_6
        ...
        }
        {
            // Button_left_history
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.button_left_history = obj;
            lv_obj_set_pos(obj, 0, 58);
            lv_obj_set_size(obj, 93, 510);
            lv_obj_set_style_pad_left(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_top(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff0ddfcd), LV_PART_MAIN | LV_STATE_PRESSED);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_pos(obj, 15, 305);
                    lv_obj_set_size(obj, 71, 72);
                    lv_obj_add_event_cb(obj, event_handler_cb_historical_record_page_obj21, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff3195e4), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc9e7ff), LV_PART_MAIN | LV_STATE_PRESSED);
                    {
                        lv_obj_t *parent_obj = obj;
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 15, 120);
                    lv_obj_set_size(obj, 71, 72);
                    lv_obj_add_event_cb(obj, event_handler_cb_historical_record_page_obj22, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc9e7ff), LV_PART_MAIN | LV_STATE_PRESSED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
        ...
        }
        {
            ...
            objects.obj47 = obj;
            lv_obj_set_pos(obj, 103, 95);
            lv_obj_set_size(obj, 905, 660);
            lv_tabview_set_tab_bar_position(obj, LV_DIR_TOP);
            lv_tabview_set_tab_bar_size(obj, 80);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff395481), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    objects.obj48 = obj;
                    lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff00457d), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_font(obj, &ui_font_24, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_border_side(obj, LV_BORDER_SIDE_TOP, LV_PART_ITEMS | LV_STATE_CHECKED);
                }
                {
                    // History_record
                    lv_obj_t *obj = lv_tabview_get_content(parent_obj);
                    objects.history_record = obj;
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            lv_obj_t *obj = lv_tabview_add_tab(lv_obj_get_parent(parent_obj), "温度日志");
                            objects.obj49 = obj;
                            lv_obj_set_style_text_font(obj, &ui_font_24, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
                                    ...
                                    lv_obj_set_size(obj, 900, 580);
                                }
                            }
                        }
                        {
                            lv_obj_t *obj = lv_tabview_add_tab(lv_obj_get_parent(parent_obj), "采样日志");
                            objects.obj50 = obj;
                            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffe082), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
                        ...
                        {
                            lv_obj_t *obj = lv_tabview_add_tab(lv_obj_get_parent(parent_obj), "故障日志");
                            {
                                lv_obj_t *parent_obj = obj;
                                {
