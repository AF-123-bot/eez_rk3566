...
extern const char *get_var_phonenum();
extern void set_var_phonenum(const char *value);
extern int32_t get_var_rotational_speed();
extern void set_var_rotational_speed(int32_t value);
extern int32_t get_var_rotational_radius();
extern void set_var_rotational_radius(int32_t value);
